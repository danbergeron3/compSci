    ...
    switch (transformType) {
        case 'scale':
            ...
            if (shape.type === 'triangle') {
                ...
                shape.yMax = currentCentroidY;
                shape.yMin = currentCentroidY - newHeight;
        ...
        case 'rotate':
            ...
            if (shape.type === 'triangle') {
                ...
                const vertex1 = { x: shape.centerX, y: shape.centerY - shape.height };
                const vertex2 = { x: shape.centerX - shape.width / 2, y: shape.centerY };
                const vertex3 = { x: shape.centerX + shape.width / 2, y: shape.centerY };
...
function drawTriangle(x1, y1, x2, y2) {
    ...
    selectedShape = {
        ...
        width: length,
        height: height, 
        centerX: (x1 + (x1 + length) + (x1 - length)) / 3,
        centerY: (y1 + (y1 + height) + (y1 + height)) / 3
    };
}
