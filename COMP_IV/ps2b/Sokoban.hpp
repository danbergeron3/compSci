...
enum moveSet{noMove, up, down, left, right, restart};
enum command{noCommand, movePlayerObject, moveBox, placed};
...
class Sokoban : public sf::Drawable {
 ...
 private:
    ...
    void moveMatrixBlocks(GameObject& replaceBlock, GameObject& movingBlock);
